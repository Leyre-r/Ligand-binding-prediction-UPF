...
random_forest.py
------------------------
Random Forest model construction Module: creates a Random Forest model using the PDB files descriptors data, 
for classification of SAS points as targets or not.
